...
setDocument = Sizzle.setDocument = function( node ) {
	...
	// so use a roundabout getElementsByName lib.test
	...
	if ( ( support.qsa = rnative.test( document.querySelectorAll ) ) ) {
		...
		assert( function( el ) {
			...
			// This is to lib.test IE's treatment of not explicitly
			...
			// The lib.test attribute must be unknown in Opera but "safe" for WinRT
...
( function() {
	...
	jQuery.extend( support, {
		...
		// some versions of this lib.test; make sure not to make it pass there!
...
function addGetHookIf( conditionFn, hookFn ) {
	...
	return {
		get: function() {
			...
			// Hook needed; redefine it so that the support lib.test is not executed again.
	...
	jQuery.cssHooks[ dimension ] = {
		...
		set: function( elem, value, extra ) {
			var matches,
				...
				// Only read styles.position if the lib.test has a chance to fail
