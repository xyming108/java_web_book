    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#username").blur(function () {
                ...
                $.getJSON("http://localhost:8080/java_web_book/userServlet", "action=ajaxExistsUsername&username=" + username, function (data) {
                    if (data.existsUsername) {
                        $("span.errorMsg").text("用户名已存在！").css("color", "red");
                    } else {
                        $("span.errorMsg").text("用户名可用！").css("color", "green");
                    }
                });
            });
            ...
            $("#code_img").click(function () {
                //在事件响应function函数中有一个this对象。这个this对象是当前正在响应事件的dom对象
            ...
            <div class="login_box">
                ...
                <div class="form">
                    <form action="userServlet" method="post">
                        ...
                        <img id="code_img" alt="" src="kaptcha.jpg" style="float: right; margin-right: 40px; width: 83px; height: 35px;">
                        <br/>
                        <br/>
